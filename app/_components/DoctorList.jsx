...
function DoctorList({ doctorList, heading = "Popular Doctors" }) {
  return (
    <div className="mb-10 pl-12 pr-4">
      <h2 className="font-bold text-xl">{heading}</h2>

      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 mt-4 lg:grid-cols-4">
        {doctorList.length > 0
          ? doctorList.map((doctor, index) => (
              ...
              >
                ...
                <div className="mt-3 items-baseline flex flex-col gap-1">
                  <h2 className="text-[10px] bg-teal-50 p-1 rounded-full px-2 text-primary">
